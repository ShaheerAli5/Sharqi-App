...
import '../features/self_service/presentation/screens/self_service_web_screen.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> get routes => {
        ...
        selfServiceWeb: (context) => const SelfServiceWebScreen(),
        selfServiceWebPortal: (context) => const SelfServiceWebScreen(),
        complaintForm: (context) => const SelfServiceWebScreen(),
        trackCase: (context) => const SelfServiceWebScreen(),
        employeeRequestForm: (context) => const SelfServiceWebScreen(),
        leaveRequestForm: (context) => const SelfServiceWebScreen(),
        brightIdeaForm: (context) => const SelfServiceWebScreen(),
        salarySlip: (context) => const SelfServiceWebScreen(),
